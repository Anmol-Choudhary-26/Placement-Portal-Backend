...
class Drive(models.Model):
    ...
    hr_name = models.CharField(default="example", null=False, max_length=200)
    hr_phone = models.CharField(default="9876543210", max_length=12)
    hr_mail = models.EmailField(default="example.com")
    class Meta:
